  ...
  return (
    <aside className="w-64 h-screen border-r border-sidebar-border bg-gradient-to-b from-sidebar to-sidebar/95 fixed left-0 top-0 flex flex-col shadow-xl">
      ...
      <div className="p-4 border-t border-sidebar-border/50">
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sidebar-foreground hover:bg-sidebar-accent/50 transition-all duration-300 group">
          <LogOut size={18} />
