      ...
      <main className="ml-64 w-[calc(100%-256px)] min-h-screen bg-gradient-to-br from-background via-background to-primary/5 p-8">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Get comprehensive risk assessment, predictions, and recommendations for your case</p>
          </div>
                  ...
                  {analysisType === "text" ? (
                    <div>
                      ...
                      <Textarea
                        ...
                        className="w-full"
                      />
                      <label className="text-sm font-medium mb-2 block mt-4">Section Numbers (optional, comma-separated)</label>
                      <Input
                        value={sections}
                    ...
                    <>
                      <div>
                        <label className="text-sm font-medium mb-2 block">Section Numbers (comma-separated)</label>
                        <Input
                          value={sections}
                          onChange={(e) => setSections(e.target.value)}
                          placeholder="302, 34, 109"
                      ...
                      <div>
                        <label className="text-sm font-medium mb-2 block">Mitigating Factors (comma-separated)</label>
                        <Textarea
                          value={mitigatingFactors}
                          onChange={(e) => setMitigatingFactors(e.target.value)}
                          placeholder="First time offender, good character, no previous record"
                          rows={3}
                        />
                      </div>
                      <div>
                        <label className="text-sm font-medium mb-2 block">Aggravating Factors (comma-separated)</label>
                        <Textarea
                          value={aggravatingFactors}
                          onChange={(e) => setAggravatingFactors(e.target.value)}
                          placeholder="Previous convictions, flight risk, witness intimidation"
                          rows={3}
                        />
                      </div>
                    </>
