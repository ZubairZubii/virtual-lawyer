          ...
          >
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div>
                ...
                <p className="text-muted-foreground">Upload, analyze, and generate legal documents for your cases</p>
              </div>
            ...
            {activeTab === "templates" && (
              <div className="space-y-6">
                ...
                <Card className="p-6 border border-border/50">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="text-sm font-medium mb-2 block">Enter Case Facts (JSON format)</label>
                      <Textarea
